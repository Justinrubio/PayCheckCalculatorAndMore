	...
	public static void main(String[] args) {
		...
		do {
			...
			try { //try- catch will prevent program from crashing from bad input.
				...
				double total = totalsUsingMethods.totalIncomeFromHours(totalHours, hourlyWage) + COMMISSION; // method
																												// is
																												// called
																												// here
				...
				String yesOrNo = usersAnswer.equals("y") ? "Great!"
						: "Too bad, this is my project, you will stay and suffer.";
				...
				int[][] comparedSpreadSheets = { { (int) hourlyWage, (int) totalHours, (int) weeklySales },
						{ 20, 40, 400 } };
